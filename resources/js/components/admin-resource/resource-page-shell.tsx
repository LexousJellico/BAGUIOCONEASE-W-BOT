...
export function ResourcePageShell({
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="bccc-resource-page space-y-5">
...
export function ResourceStatCard({
    ...
    return (
        <article className="bccc-resource-stat-card border border-slate-200 bg-white p-4 shadow-sm dark:border-white/10 dark:bg-white/[0.055]">
            <div className="flex items-start justify-between gap-3">
                <div>
                    ...
                    <p className="bccc-resource-stat-value mt-2 text-3xl font-semibold tracking-[-0.06em] text-[#21180d] dark:text-white">
                        {value}
                    </p>
                </div>
