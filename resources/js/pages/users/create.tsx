            ...
            <div className="mx-auto max-w-6xl p-6">
                <div className="mb-6">
                    ...
                    <p className="text-sm text-muted-foreground">
                        Use the same richer account fields now used by the
                        public registration and profile flow.
                    </p>
                </div>
                        ...
                        <CardContent className="grid gap-4 md:grid-cols-2">
                            ...
                            <div className="grid gap-2">
                                ...
                                <Input
                                    ...
                                    onChange={(e) =>
                                        setData('phone_number', e.target.value.replace(/\D/g, '').slice(0, 11))
                                    }
                                    placeholder="09171234567"
                                />
                                <p className="text-xs text-muted-foreground">
                                    Use Philippine mobile format like
                                    09171234567.
                                </p>
                                {errors.phone_number && (
                                    <p className="text-sm text-destructive">
                        ...
                        <CardContent className="grid gap-4 md:grid-cols-2">
                            ...
                            <div className="flex items-center gap-3 rounded-lg border border-dashed px-4 py-3 md:mt-7">
                                ...
                                <div className="grid gap-1">
                                    ...
                                    >
                                        Mark email as verified now
                                    </Label>
                                    <p className="text-xs text-muted-foreground">
                                        Helpful for localhost while email
